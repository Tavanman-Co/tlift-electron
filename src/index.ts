...
const updateServer = {
  [enumEnvNames.staging]: "https://update-staging.tavanmandteam.ir",
  [enumEnvNames.local]: "https://update-local.tavanmandteam.ir",
  [enumEnvNames.production]: "https://update.sepehr-asansor.ir",
}

autoUpdater.setFeedURL({
  url: `${updateServer[getEnvName()]}/update/win64/${app.getVersion()}`,
})
setInterval(() => {
  console.log('====================================');
  console.log("hereee");
...
autoUpdater.on("checking-for-update",console.log)
